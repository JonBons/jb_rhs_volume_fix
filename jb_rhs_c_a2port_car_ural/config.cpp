...
class cfgVehicles {
	...
	class RHS_Ural_BaseTurret: Truck_F
	{
		class Sounds
		{
			...
			{
				sound[] = {"rhsafrf\addons\rhs_a2port_car\sounds\UAZ\uaz_int_low1_exhaust","db+3.15",1};
			};
			...
			{
				sound[] = {"rhsafrf\addons\rhs_a2port_car\sounds\UAZ\uaz_int_high1_exhaust","db+1.75",1};
			};
			class Engine5_Thrust_int
			{
				sound[] = {"rhsafrf\addons\rhs_a2port_car\sounds\UAZ\uaz_int_high1_exhaust","db+1.4",1};
			};
			class RainIn
			{
				sound[] = {"rhsafrf\addons\rhs_a2port_car\sounds\rain.wss","db+1.05",1};
			};
			class TiresRockIn
			{
